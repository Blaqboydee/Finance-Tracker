...
const SpendlyDashboard = () => {
  ...
  return (
    <div
      className={`pt-20 flex justify-center items-center  font-sans transition-colors duration-300 ${
        isDarkMode
          ? "bg-slate-800"
          : "bg-white"
      }`}
      ...
      <div className="w-[100%]">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Biggest Category (fallback safe) - keeping your original logic */}
            <div
            ...
            >
              ...
              {highestAmount ? (
                ...
                <>
                  ...
                  <div className={`text-xs mt-1 ${isDarkMode ? "text-slate-600" : "text-slate-400"}`}>
                    ₦0
                  </div>
                </>
              )}
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      label={({ name, percent }) =>`${categoryMap[name] || name} ${(percent * 100).toFixed(0)}%`}
   ...
   <NavLink
  to={"/layout/expenses"}
  className={`w-40 text-center text-sm px-28 py-2 md:py-4 rounded-md md:rounded-2xl font-semibold mb-2 md:mb-4 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] hover:shadow-xl ${
    isDarkMode
