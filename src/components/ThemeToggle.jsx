...
const ThemeToggle = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <button
      ...
      className="relative p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group"
